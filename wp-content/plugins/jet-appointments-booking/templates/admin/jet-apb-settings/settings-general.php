<div>
	<cx-vui-select
		...
		:size="'fullwidth'"
		:value="generalSettings.services_cpt"
	...
	<cx-vui-select
		...
		:wrapper-css="[ 'equalwidth' ]"
		:size="'fullwidth'"
		:value="generalSettings.providers_cpt"
	...
	<cx-vui-switcher
		...
		:wrapper-css="[ 'equalwidth' ]"
		:value="generalSettings.manage_capacity"
	...
	<cx-vui-switcher
		...
		:wrapper-css="[ 'equalwidth' ]"
		v-if="generalSettings.manage_capacity"
		:value="generalSettings.show_capacity_counter"
	...
	<cx-vui-select
		...
		:wrapper-css="[ 'equalwidth' ]"
		:size="'fullwidth'"
		:value="generalSettings.slot_time_format"
