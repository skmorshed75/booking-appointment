...
class Plugin {
	...
	public function register_assets() {
		...
		$this->register_script( 'jet-apb-working-hours', 'admin/working-hours.js' );
		$this->register_script( 'jet-apb-settings', 'admin/settings.js' );
		$this->register_script( 'jet-apb-set-up', 'admin/set-up.js' );
